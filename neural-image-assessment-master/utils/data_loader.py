...
base_images_path = r'/home/bkcs/NIMA/images/images2/'
ava_dataset_path = r'/home/bkcs/NIMA/AVA.txt'
...
def features_generator(record_path, faeture_size, batchsize, shuffle=True):
    ...
    with tf.Session() as sess:
        ...
        train_dataset = train_dataset.batch(batchsize, drop_remainder=True) #train_dataset = train_dataset.batch(batchsize, drop_remainder=True)
